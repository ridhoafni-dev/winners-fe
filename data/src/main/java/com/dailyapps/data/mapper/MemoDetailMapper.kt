...
class MemoDetailMapper @Inject constructor(): Mapper<BaseResponse<MemoApiResponse>, Memo> {
    override fun mapFromApiResponse(type: BaseResponse<MemoApiResponse>): Memo {
